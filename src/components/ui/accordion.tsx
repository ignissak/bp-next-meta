...
>(({ className, children, ...props }, ref) => (
  <AccordionPrimitive.Header className="flex">
    <AccordionPrimitive.Trigger
      ref={ref}
      className={cn(
        "flex flex-1 items-center justify-between py-4 text-base font-medium transition-all text-left [&[data-state=open]>svg]:rotate-180 hover:opacity-80 duration-200",
        className
      )}
      {...props}
    >
